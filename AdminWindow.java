...
public class AdminWindow extends JFrame {
    ...
    private void cargarCuentas() {
        ...
        for (Usuario usuario : banco.getCuentas()) {
            model.addRow(new Object[] { usuario.getNombre(), usuario.getNumeroCuenta(), usuario.getSaldo(),usuario.getRol()});
        }
    }
    ...
    private void agregarCuenta() {
        ...
        String nombre = juser.getText(); // OptionPane.showInputDialog(this, "Nombre ");
        String password = jpass.getText(); // JOptionPane.showInputDialog(this, "Password ");
        String cuenta = String.valueOf(numberAcount()); // JOptionPane.showInputDialog(this, "Número de Cuenta:");
    ...
    public int numberAcount() {
        int eightDigitNumber;
        Random random = new Random();
        return (eightDigitNumber = 10000000 + random.nextInt(90000000));
